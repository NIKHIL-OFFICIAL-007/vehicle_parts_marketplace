...
<head>
  ...
  <style>
    ...
    .main-content-container {
      min-height: calc(100vh - 16rem); /* Adjusted for footer space */
    }
  </style>
</head>
<body class="bg-gray-50 font-sans flex flex-col min-h-screen">
  ...
  <nav class="bg-primary text-white px-4 py-3 flex justify-between items-center sticky top-0 z-50 shadow-lg">
    <div class="flex items-center space-x-4">
      ...
      <div class="flex items-center">
        <i class="fas fa-car text-xl text-secondary mr-2"></i>
        <h1 class="text-xl font-bold">AutoParts</h1>
      </div>
    </div>
    ...
    <div class="flex items-center space-x-4">
      ...
      <a href="cart.php" class="relative text-white">
      ...
      <a href="logout.php" class="bg-red-500 px-4 py-2 rounded text-white text-sm hover:bg-red-600 transition-colors">Logout</a>
    </div>
  </nav>
  ...
  <div class="flex flex-1">
    ...
    <div id="sidebar" class="w-64 bg-white shadow-lg fixed top-16 h-[calc(100vh-4rem)] overflow-y-auto z-40 transition-all duration-300 -translate-x-full md:translate-x-0 scrollbar-hide">
    ...
    <!-- Main Content Area -->
    <div class="flex-1 md:ml-64 main-content-container">
      <!-- Banner Carousel -->
      ...
      <div class="bg-white py-4 shadow-sm">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-lg font-semibold mb-3 text-gray-800">Shop by Category</h2>
          <div class="flex overflow-x-auto pb-2 space-x-4 scrollbar-hide">
            <a href="#" class="flex flex-col items-center min-w-max">
              <div class="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mb-2">
                <i class="fas fa-car-battery text-primary text-xl"></i>
              </div>
              <span class="text-sm font-medium">Batteries</span>
            </a>
            <a href="#" class="flex flex-col items-center min-w-max">
              <div class="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mb-2">
                <i class="fas fa-oil-can text-primary text-xl"></i>
              </div>
              <span class="text-sm font-medium">Oil & Filters</span>
            </a>
            <a href="#" class="flex flex-col items-center min-w-max">
              <div class="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mb-2">
            ...
            <a href="#" class="flex flex-col items-center min-w-max">
              <div class="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mb-2">
                <i class="fas fa-tire text-primary text-xl"></i>
              </div>
              <span class="text-sm font-medium">Tires & Wheels</span>
            </a>
            <a href="#" class="flex flex-col items-center min-w-max">
              <div class="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mb-2">
                <i class="fas fa-wind text-primary text-xl"></i>
              </div>
              <span class="text-sm font-medium">AC & Heating</span>
            </a>
            <a href="#" class="flex flex-col items-center min-w-max">
              <div class="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mb-2">
  ...
  <script>
    ...
    document.querySelectorAll('.category-filter, .brand-filter, #priceRange, #sortSelect').forEach(element => {
