        ...
        if ($stmt->rowCount() > 0) {
            ...
            if (!$message) {
                try {
                    ...
                    // Email can be used in headers, so escape it
      ...
      <form method="POST" class="p-8 space-y-6">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Roles (Read-only) -->
            <div class="input-group">
              <label><i class="fas fa-user-tag text-blue-500 mr-1"></i> Account Roles</label>
              <input type="text" value="<?= implode(', ', array_map('ucfirst', $roles)) ?>" disabled>
            </div>
