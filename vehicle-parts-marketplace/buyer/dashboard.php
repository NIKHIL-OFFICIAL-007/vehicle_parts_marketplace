...
<body class="bg-gray-50 text-gray-900">
  ...
  <div class="bg-white rounded-xl shadow-md p-6 mb-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
      ...
      <a href="../../buyer/browse_parts.php" class="flex flex-col items-center p-4 bg-gray-50 hover:bg-green-600 hover:text-white rounded-lg transition transform hover:-translate-y-1">
        <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-green-600 mb-3">
          <i class="fas fa-search text-xl"></i>
        </div>
        <span class="font-medium">Browse Parts</span>
      </a>
    </div>
  </div>
