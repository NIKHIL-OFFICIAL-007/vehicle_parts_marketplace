...
$has_pending = false;
if (isset($user['role_request']) && $user['role_request'] === 'support' && $user['role_status'] === 'pending') {
    $has_pending = true;
}
...
if ($_POST) {
    ...
    try {
        ...
        // Add notification
        $pdo->prepare("INSERT INTO notifications (user_id, message, type) VALUES (?, 'Your support application has been submitted.', 'info')")
            ->execute([$user_id]);
...
<head>
  ...
  <title>Apply as Support - AutoParts Hub</title>
  ...
  <div class="container mx-auto px-6 py-12 max-w-4xl">
    <div class="form-container">
      <div class="form-header text-center">
        <h1 class="text-2xl font-bold mb-2">Apply as Support Agent</h1>
        <p class="opacity-90">Help customers with their queries and ensure smooth experience on the platform.</p>
      </div>
      ...
      <form method="POST" class="form-body">
        ...
        <div class="form-step active" id="step1">
          <div class="mb-6">
            ...
            <p class="text-gray-600">Why do you want to be a support agent?</p>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea 
              ...
              class="form-textarea" 
              rows="4" 
              placeholder="Why do you want to help users? What makes you good at communication?"
          ...
          <div class="form-group">
            ...
            <textarea 
              ...
              class="form-textarea" 
              rows="4" 
              placeholder="Any customer service experience, language skills, or problem-solving background?"
          ...
          <div class="bg-blue-50 p-4 rounded-lg border border-blue-100 mt-6">
            <h3 class="font-semibold text-blue-800 mb-2 flex items-center">
              <i class="fas fa-info-circle mr-2"></i> What we look for in support agents
            </h3>
            <ul class="feature-list">
              <li><i class="fas fa-check-circle"></i> Strong communication and empathy skills</li>
              <li><i class="fas fa-check-circle"></i> Patience and problem-solving mindset</li>
              <li><i class="fas fa-check-circle"></i> Availability during peak hours</li>
        ...
        <div class="form-step" id="step3">
          <div class="text-center py-8">
            ...
            <p class="text-gray-600 max-w-md mx-auto mb-6">
              By submitting, you agree to provide timely and helpful support to users. Our team will contact you soon.
            </p>
