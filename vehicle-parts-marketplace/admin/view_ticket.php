          ...
          <div class="p-6 space-y-6">
            ...
            <div class="p-4 bg-blue-50 rounded-lg">
              <div class="flex justify-between items-center mb-2">
                <strong><?= htmlspecialchars($ticket['user_name']) ?> (Customer)</strong>
            ...
            <?php foreach ($replies as $reply): ?>
              <div class="p-4 <?= $reply['sender_role_name'] === 'support' ? 'bg-green-50' : 'bg-blue-50' ?> rounded-lg">
                <div class="flex justify-between items-center mb-2">
                  <strong><?= htmlspecialchars($reply['sender_name']) ?> (<?= ucfirst($reply['sender_role_name']) ?>)</strong>
